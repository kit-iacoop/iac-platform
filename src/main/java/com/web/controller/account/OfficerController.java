...
public class OfficerController {
    ...
    @PostMapping("officer/mypage/update")
    public ModelAndView updateInformation(@Validated @ModelAttribute OfficerInformationDTO accInfDto, Errors errors, ModelAndView mav, HttpServletRequest req){
